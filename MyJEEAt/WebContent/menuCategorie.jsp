...
<body>
	...
	<button type="button" class="btn btn-primary btn-lg btn-block"><a href="gererCategorie.jsp" class="badge badge-primary">Gérer les catégories</a></button>
	<br>
